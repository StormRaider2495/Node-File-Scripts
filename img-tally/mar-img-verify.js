...
var list = [
    'blending_image_list',
    'blendingb_image_list',
    'click_to_choose_image_list',
    'drag_drop_image_list',
    'matching_image_list',
    'proof_reading_pro_image_list',
    'sorting_image_list',
    'sorting_open_defined_image_list',
    'spelling_image_list',
    'word_letter_focus_image_list',
    'word_vault_image_list'
];
